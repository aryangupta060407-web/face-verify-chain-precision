    ...
    try:
        ...
        return jsonify({
            ...
            "match": {
                ...
                "faceSimilarity": match.get("face_similarity"),
                "imageSimilarity": match.get("image_similarity"),
                "similarity": match.get("face_similarity", match.get("similarity")),
                "exactMatches": match.get("exact_matches", False),
